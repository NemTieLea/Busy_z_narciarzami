...
#    niektorzy wioza 1, 2 lub 3 pary nart -> losowa liczba dla kazdego narciarza
# powiedz w ilu busach pojada narciarze
...
for narciarz in range(liczba_narciarzy):
    ...
    if liczba_nart_w_busie + liczba_nart_narciarza > MAKSYMALNA_LICZBA_NART_W_BUSIE:
        print(f"Bus odjezdza z {liczba_nart_w_busie} parami nartami!")
